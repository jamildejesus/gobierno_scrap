...
class TlaxcaladictamenSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for row in rows[1:]:
            ...
            urlAttachRaw = columns[2].xpath(".//a/@href").get()
