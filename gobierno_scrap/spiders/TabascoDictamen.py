...
from gobierno_scrap.items import TabascoDictamenItem
from gobierno_scrap.utils.methods import UtilsMethods


class TabascoDictamenSpider(scrapy.Spider):
    name = "TabascoDictamen"
    allowed_domains = ["congresotabasco.gob.mx"]
    start_urls = ["https://congresotabasco.gob.mx/dictamenes/"]
